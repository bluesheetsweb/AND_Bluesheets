...
public class TagView extends RelativeLayout {
     ...
     * tag list
     */
    private List<TagItem> mTags = new ArrayList<>();
    ...
    private void initialize(Context ctx, AttributeSet attrs, int defStyle) {
        ...
        this.lineMargin = (int) typeArray.getDimension(R.styleable.TagView_lineMargin, TagUtils.dipToPx(this.getContext(), TagConstants.DEFAULT_LINE_MARGIN));
        this.tagMargin = (int) typeArray.getDimension(R.styleable.TagView_tagMargin, TagUtils.dipToPx(this.getContext(), TagConstants.DEFAULT_TAG_MARGIN));
        this.textPaddingLeft = (int) typeArray.getDimension(R.styleable.TagView_textPaddingLeft, TagUtils.dipToPx(this.getContext(), TagConstants.DEFAULT_TAG_TEXT_PADDING_LEFT));
        this.textPaddingRight = (int) typeArray.getDimension(R.styleable.TagView_textPaddingRight, TagUtils.dipToPx(this.getContext(), TagConstants.DEFAULT_TAG_TEXT_PADDING_RIGHT));
        this.textPaddingTop = (int) typeArray.getDimension(R.styleable.TagView_textPaddingTop, TagUtils.dipToPx(this.getContext(), TagConstants.DEFAULT_TAG_TEXT_PADDING_TOP));
        this.textPaddingBottom = (int) typeArray.getDimension(R.styleable.TagView_textPaddingBottom, TagUtils.dipToPx(this.getContext(), TagConstants.DEFAULT_TAG_TEXT_PADDING_BOTTOM));
        typeArray.recycle();
    }
    ...
    private void drawTags() {
        ...
        TagItem tagPre = null;
        for (TagItem item : mTags) {
            final int position = listIndex - 1;
            final TagItem tag = item;
...
//                int offset = TagUtils.dipToPx(getContext(), 2f);
...
//            }
            ...
            Log.e("mWidth is ","mWidth "+mWidth);
            if (mWidth <= total + tagWidth + TagUtils.dipToPx(this.getContext(), TagConstants.LAYOUT_WIDTH_OFFSET)) {
    ...
    private Drawable getSelector(TagItem tag) {
        ...
        if (tag.getLayoutBorderSize() > 0) {
            gdNormal.setStroke(TagUtils.dipToPx(getContext(), tag.getLayoutBorderSize()), tag.getLayoutBorderColor());
        }
    ...
    public void addTags(List<TagItem> tags) {
        if (tags == null) return;
        mTags = new ArrayList<>();
        if (tags.isEmpty())
            drawTags();
    ...
    public void setLineMargin(float lineMargin) {
        this.lineMargin = TagUtils.dipToPx(getContext(), lineMargin);
    }
    ...
    public void setTagMargin(float tagMargin) {
        this.tagMargin = TagUtils.dipToPx(getContext(), tagMargin);
    }
    ...
    public void setTextPaddingLeft(float textPaddingLeft) {
        this.textPaddingLeft = TagUtils.dipToPx(getContext(), textPaddingLeft);
    }
    ...
    public void setTextPaddingRight(float textPaddingRight) {
        this.textPaddingRight = TagUtils.dipToPx(getContext(), textPaddingRight);
    }
    ...
    public void setTextPaddingTop(float textPaddingTop) {
        this.textPaddingTop = TagUtils.dipToPx(getContext(), textPaddingTop);
    }
    ...
    public void settextPaddingBottom(float textPaddingBottom) {
        this.textPaddingBottom = TagUtils.dipToPx(getContext(), textPaddingBottom);
    }
    ...
    public interface OnTagDeleteListener {
        void onTagDeleted(OnClickListener view, TagItem tag, int position);
    }

    public interface OnTagClickListener {
        void onTagClick(TagItem tag, int position);
    }

    public interface OnTagLongClickListener {
        void onTagLongClick(TagItem tag, int position);
    }
}
